...
namespace Sitecore.SharedSource.DataImporter.Providers
{
	...
	public abstract class BaseDataMap
    {
        ...
        /// <summary>
        /// use this function to report end of the import process
        /// </summary>
        public abstract void ImportEndReport();
        ...
        /// </summary>
        protected virtual Item GetParentNode(object importRow, string newItemName)
        {
            ...
            if (this.FolderByDate)
            {
                ...
                if (!string.IsNullOrEmpty(dateValue))
                {
                    ...
                    {
                        if (!DateTime.TryParseExact(dateValue, new string[] { "d/M/yyyy", "d/M/yyyy HH:mm:ss" }, CultureInfo.InvariantCulture, DateTimeStyles.None, out date))
