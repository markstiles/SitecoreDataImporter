...
namespace Sitecore.SharedSource.DataImporter.HtmlAgilityPack
{
    /// <summary>
    ...
    public class HtmlNodeNavigator : XPathNavigator
    {
        ...
        internal void InternalTrace(object traceValue)
        {
            ...
            Sitecore.SharedSource.DataImporter.HtmlAgilityPack.Trace.WriteLine(string.Format("oid={0},n={1},a={2},v={3},{4}", GetHashCode(), nodename, _attindex, nodevalue, traceValue), "N!" + name);
        }
